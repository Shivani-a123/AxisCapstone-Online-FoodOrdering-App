...
<div class="container-fluid">
  <img src="resources/images/mainlogo.jpeg" width="35" height="35" class="d-inline-block align-top" alt="">
  <a class="navbar-brand" href="/"><h3 class="text-color"><i>FOODBOX</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
                 <li class="nav-item active">
                    <a class="nav-link" href="admindashboard"><b class="text-color">Admin</b> <span class="sr-only">(current)</span></a>
                 </li>
    <%
        	 }
    %>
    ...
    %>
      <ul class="navbar-nav ml-auto text-color">
       <li class="nav-item active">
        <div class="nav-link" data-toggle="modal" data-target=".forgetpasswordmodal"><b class="text-color">Forgot password?</b></div>
      </li> 
  ...
  <tbody>
   ...
   %>
    <tr class="text-center">
      ...
      <td class="mid-align"><%=c.getDates() %></td> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              Foodbox is a restaurant chain that delivers food items of different cuisines at affordable prices. It was established in 2014 in Bengaluru.
              <br><br> Foodbox has created an online food delivery app for the benefit of customers.
          </b>
        </p>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonelogo.png" style="width:65px;" alt="img">+91 9600124432 <br>
                <img src="resources/images/msglogo.png" style="width:29px;" alt="img">shivi242001@gmail.com
            </b>
        </p>
        </div>
      </div>
