		...
		<div class="row mt-3">
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 120px" class="img-fluid rounded-circle"
								src="resources/images/userlogo.jpeg" alt="users_pic">
						</div>
						<h1><%=userDao.count()%></h1>
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 180px" class="img-fluid rounded-circle"
								src="resources/images/cuisinelogo.png" alt="users_pic">
						</div>
						<h1><%=categoryDao.count()%></h1>
						<h2 class="text-uppercase text-muted">Total Cuisines</h2>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 120px" class="img-fluid rounded-circle"
								src="resources/images/cartlogo.jpeg" alt="users_pic">
						</div>
						<h1><%=foodDao.count()%></h1>
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 120px" class="img-fluid rounded-circle"
								src="resources/images/ticklogo.jpeg" alt="users_pic">
						</div>
				...
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						<div class="container md-5">
							<img style="max-width: 110px" class="img-fluid rounded-circle"
								src="resources/images/pluslogo.jpeg" alt="users_pic">
						</div>
						<p class="text-lowercase text-muted mt-2 " style="font-size: 22px">click
							to add cuisine</p>
						<h2 class="text-uppercase text-muted mt-1">Add Cuisine</h2>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 120px" class="img-fluid rounded-circle"
								src="resources/images/addcartlogo.jpeg" alt="users_pic">
						</div>
						<p class="text-lowercase text-muted mt-2 " style="font-size: 22px">click
							to add food</p>
				...
				<div class="modal-body">
					<form action="addcategory" method="post">
						...
						<div class="container text-center">
							<button class="btn custom-bg text-color">Add Cuisine</button>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td class="mid-align"><a href="deletefood?foodId=<%=p.getId()%>"><input type="submit" class="btn btn-danger" value="Delete"></a></td>
								</tr>
								<%
								}
								%>
